...
class PreviewAdapter(val board: Board): RecyclerView.Adapter<PreviewAdapter.ViewHolder>()
{
    ...
    {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.preview_post_item, parent, false)
    ...
    inner class ViewHolder(view: View, val context: Context, val board: Board): RecyclerView.ViewHolder(view)
    {
        ...
        private val postTitle = view.findViewById<TextView>(R.id.preview_post_title)
        private val postDate = view.findViewById<TextView>(R.id.preview_post_date)
